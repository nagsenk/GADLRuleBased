...
def summ_rating_flatten_coll_fn(batch, word2idx, src_max_len=-1, trg_max_len=-1):
    ...
    for src_sent_list, trg_sent_list, rating in batch:
        #print(src_sent_list)
        #print("new")
        source_sent_2d_list.append(src_sent_list)
...
#            if len(f_sent_position) == 0:
 #               continue
    ...
    #print("batch size")
    #print(batch_size)
    #print("source list tokenized")
    #print(source_list_tokenized)
    #print("target_list_tokenized")
    #print(target_list_tokenized)
    #print("word2idx")
 #   print(word2idx)
    # convert to idx
...
#    print(source_list)
    ...
    batch_dict['src_sent_2d_list']=source_sent_2d_list

    batch_dict['rating_tensor'] = rating_tensor
    batch_dict['original_indices'] = original_indices
    # print("batch dict #########################################################################################################")
    # print(batch_dict[0])
    # print(batch_dict['src_sent_2d_list'])
    return batch_dict
