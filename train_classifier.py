...
def build_loader(data_path, batch_size, word2idx, src_max_len, trg_max_len, num_workers, weighted_sampling):
    ...
    # print("word2idx ****************************************************************************************")
    # print(word2idx)
    # print("coll fn customized *********************************************************************")
    # print(coll_fn_customized)
...
def main(opt):
    try:
        ...
        # train the model
        ml _pipeline.train_model(overall_model, optimizer_ml, train_data_loader, valid_data_loader, opt, train_classification_loss_func, val_classification_loss_func)
        #GA.GeneticAlgorithm(overall_model, optimizer_ml, train_data_loader, valid_data_loader, opt, train_classification_loss_func, val_classification_loss_func)
